...
def build_first_customers_suite() -> gx.ExpectationSuite:
    return build_suite(RAW_CUSTOMERS_SCHEMA, KEY_COLUMNS, PRIMARY_KEY_COLUMNS, name="first_customers_suite")

def build_enriched_customers_suite() -> gx.ExpectationSuite:
    suite = build_suite(ENRICHED_CUSTOMERS_SCHEMA, KEY_COLUMNS, PRIMARY_KEY_COLUMNS, name="enriched_customers_suite")
