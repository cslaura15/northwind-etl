...
def northwind_etl():
    ...
    def transform(**context):
        ...
        return {"enriched_customers": enrich_customers_path, "orders": data_paths["orders"], "region_mapping": data_paths["region_mapping"]}
    ...
    def load(**context):
        ...
        enriched_customers_df.to_sql("enriched_customers", engine, if_exists="replace", index=False)
